...
public class SpTagScreen extends MainScreen implements TagCreatorScreen {

	private SpTagScreen _screen;
	...
	private LabelField _instuctions = new LabelField("SP tag:Bring a tag into NFC field to write");
    private SeparatorField separator0 = new SeparatorField(Field.USE_ALL_WIDTH);
	
	private EditField _urlField = new EditField("URL: http://www.", "bbc.co.uk");
	...
	public SpTagScreen() {
		...
		this._screen = this;
		this._smartTagListener = new NfcWriteNdefSmartTagListener(_screen, Constants.TYPE_SP);
    ...
    public String getTagDetails() {
        return "URL="+getUrlField()+",TEXT="+getTxtField();
    }

    public Hashtable getTagAttributes() {
        _tag_attrs.put(Constants.TAG_ATTRIBUTE_URI, getUrlField());
