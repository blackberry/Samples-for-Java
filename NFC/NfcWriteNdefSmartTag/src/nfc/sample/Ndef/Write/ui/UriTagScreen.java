...
public class UriTagScreen extends MainScreen implements TagCreatorScreen {

	private UriTagScreen _screen;
	...
	private LabelField _instuctions = new LabelField("URI tag: Bring a tag into NFC field to write");
    private SeparatorField separator0 = new SeparatorField(Field.USE_ALL_WIDTH);
	
	private EditField _urlField = new EditField("URI: http://www.", "bbc.co.uk");
	...
	public UriTagScreen() {
		...
		this._screen = this;
		this._smartTagListener = new NfcWriteNdefSmartTagListener(_screen, Constants.TYPE_URI);
